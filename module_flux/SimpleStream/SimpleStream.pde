...
//  TweetStream s = new TweetStream(this, "stream.twitter.com", 80, "1/statuses/sample.json", "LOGIN", "pass");
    TweetStream s = new TweetStream(this, "stream.twitter.com", 80, "1/statuses/filter.json?track=ok", "LOGIN", "password");
  s.go();
}
