...
public class SCSynth extends SCNode
{
	...
	public SCSynth(String synthname)
	{
		this.synthname = synthname;
		args = new Hashtable();
		
		this.server = SCServer.local;
		this.group = server.default_group;
	}

	public SCSynth (String synthname, SCServer server)
	{
		this.synthname = synthname;		
		this.server = server;
		this.group = server.default_group;
	...
	public SCSynth (String synthname, SCGroup group)
	{
		this.synthname = synthname;
		this.group = group;
...
//				println("EXCEPTION: " + ex);
		...
		SCServer.osc.send(bundle, server.addr);
	...
	{
//		SCServer.osc.plug(target, action, "/n_set");
		if (created)
		{
