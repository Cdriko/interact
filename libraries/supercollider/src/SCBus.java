/*
	...
	p5_sc: A SuperCollider library for Processing.
...
public class SCBus
{
	...
	public SCBus()
	{
		this("audio", SCServer.local, 1);
	}

	public SCBus(int channels)
	{
		this("audio", SCServer.local, channels);
	}

	public SCBus(String type, int channels)
	{
		this("audio", SCServer.local, 1);
	}
	
	public SCBus (String type, SCServer server, int channels)
	{
		this.type      = type;
		this.server    = server;
