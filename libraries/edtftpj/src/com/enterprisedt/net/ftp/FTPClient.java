...
public class FTPClient implements FTPClientInterface {
     ...
     *  Revision control id
     */
    public static String cvsId = "@(#)$Id: FTPClient.java,v 1.116 2010-04-26 15:55:46 bruceb Exp $";
    ...
    public boolean connected() {
        if (control==null)
           return false;
            ...
            return control.controlSock.isConnected();
        }
    }
    ...
    interface DirectoryCallback {
        ...
        public void listEntry(String entry) throws ParseException;
    }
        ...
        public void listEntry(String entry) throws ParseException {
            FTPFile file = fileFactory.parse(entry);
             if (lister != null && file != null) {
                file.setPath(path);
                lister.listDirectoryEntry(new DirectoryListArgument(file));
            }
        }
    }
